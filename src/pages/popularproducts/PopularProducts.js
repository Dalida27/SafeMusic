...
const PopularProducts = () => {
    ...
    const productsCollectionRef = collection(db, "popularproducts")
      ...
      <div className=''>
        <div className='bg-back font-mono text-[#a98467]'>
            <div className='text-center w-3/5 mx-auto pt-5 pb-10'>
              ...
              <p className='pt-3 font-semibold'>В ассортименте нашего магазина вы можете увидить самые популярные виниловые пластинки. Если вы не нашли в нашем каталоге какой-либо новый релиз, то можете связаться с нами по электронной почте или WhatsApp и мы постараемся привезти его для вас.</p>
            </div>
        </div>
        <div className='flex justify-between text-[#a98467]'>
          <div className='w-1/5 bg-back'>
